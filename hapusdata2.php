      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="hapusdata.php">Berdasar Bulan</a>
            <a class="collapse-item" href="hapusdata2.php">Berdasar Tiket</a>
          </div>
        </div>
      </li>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Hapus Data Gangguan</h1>
          <p class="mb-4">Hapus data gangguan berdasarkan status tiket saat customer megajukan laporan gangguan</p>
             ...
             <!-- Card Cari-->
              ...
              <label class="control-label col-lg-2">Pilih Status Tiket</label>
              <div class="col-lg-4">
                  ...
                  <br>
                  <input type="submit" name="pilih" value="pilih" class="btn btn-warning">
                  </h4>
              </div>
