    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Pencarian Data Gangguan</h1>
          <p class="mb-4">Mencari data gangguan berdasarkan bulan saat customer megajukan laporan gangguan</p>
