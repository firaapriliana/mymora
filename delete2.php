    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <p class="mb-4">Menghapus data gangguan berdasarkan status tiket saat customer megajukan laporan gangguan</p>
             ...
             <!-- Card Peringatan-->
              <div class="card mb-4">
                ...
                <div class="card-body">
                  Data Status Tiket berhasil terhapus
                </div>
              </div>
              ...
              <?php 
                $hasil = mysqli_query($koneksi,"select * from tbl_gangguan");   
