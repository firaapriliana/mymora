             ...
             <!-- Card Cari-->
              <div class="card mb-4">
                ...
                <div class="card-body">
                  ...
                  $data2 = mysqli_query($koneksi,"SELECT * ,datediff(current_time(),tanggal) as Durasi from tbl_tambahanteknisitemp where teknisi='$hasil'ORDER BY tanggal,jam ASC");
                  while($d = mysqli_fetch_array($data2)){
                  			...
                  			<tr>
                  				...
                  				<th><?php echo ("<a href='editteknisi2.php?NoInet=$d[NoInet]'>Edit</a>"); ?></th>
                  			</tr>
                  			<?php
                  		}
                  		?>
